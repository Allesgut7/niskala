...
void ChartScreen::setupUI()
{
    ...
    symbolLabel->setStyleSheet("color: #888888;");
    ...
    tfLabel->setStyleSheet("color: #888888;");
    ...
    m_ma5Check->setStyleSheet("color: #ffc107;");
    ...
    m_ma20Check->setStyleSheet("color: #00bcd4;");
    ...
    m_volumeCheck->setStyleSheet("color: #e0e0e0;");
